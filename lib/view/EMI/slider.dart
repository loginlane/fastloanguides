  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Tenure Years',style : _getStyle(size: 25, color: AppColor.orangeColor)),
          Slider(thumbColor: AppColor.orangeColor,
              secondaryActiveColor: AppColor.orangeColor,
              activeColor: AppColor.orangeColor,
              inactiveColor: AppColor.orangeColor,
              value: _years,
              max: 50,
              divisions: 20,
